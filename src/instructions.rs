...
pub const INSTRUCTION_ENCODINGS_TABLE: &[InstructionEncoding] = &[
    ...
    InstructionEncoding {
        ...
        bits: &[InstructionBits {
            usage: InstructionBitsUsage::Literal,
            bit_count: 8,
            value: 0b10100100, // Last byte is w, if w = 0, operates on byte
        }],
        affected_cpu_flags: CpuFlags::empty(),
    },
    InstructionEncoding {
        op: OperationType::Movsw,
        bits: &[InstructionBits {
            usage: InstructionBitsUsage::Literal,
            bit_count: 8,
            value: 0b10100101, // Last byte is w, if w = 0, operates on byte
        }],
        affected_cpu_flags: CpuFlags::empty(),
    },
    InstructionEncoding {
        op: OperationType::Lodsb,
        bits: &[InstructionBits {
            usage: InstructionBitsUsage::Literal,
            bit_count: 8,
            value: 0b10101100, // Last byte is w, if w = 0, operates on byte
        }],
        affected_cpu_flags: CpuFlags::empty(),
    },
    InstructionEncoding {
        op: OperationType::Lodsw,
        bits: &[InstructionBits {
            usage: InstructionBitsUsage::Literal,
            bit_count: 8,
            value: 0b10101101, // Last byte is w, if w = 0, operates on byte
        }],
        affected_cpu_flags: CpuFlags::empty(),
    },
    InstructionEncoding {
        op: OperationType::Stosb,
        bits: &[InstructionBits {
            usage: InstructionBitsUsage::Literal,
            bit_count: 8,
            value: 0b10101010, // Last byte is w, if w = 0, operates on byte
        }],
        affected_cpu_flags: CpuFlags::empty(),
    },
    InstructionEncoding {
        op: OperationType::Stosw,
        bits: &[InstructionBits {
            usage: InstructionBitsUsage::Literal,
            bit_count: 8,
    ...
    InstructionEncoding {
        op: OperationType::Scasb,
        bits: &[InstructionBits {
            usage: InstructionBitsUsage::Literal,
            bit_count: 8,
            value: 0b10101110, // Last byte is w, if w = 0, operates on byte
        }],
        affected_cpu_flags: CpuFlags::empty(),
    },
    InstructionEncoding {
        op: OperationType::Scasw,
        bits: &[InstructionBits {
            usage: InstructionBitsUsage::Literal,
            bit_count: 8,
